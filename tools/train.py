...
from core.loss import MultiLoss, SmoothL1Loss
...
def main():
    ...
    # criterion = SmoothL1Loss(cfg.LOSS.USE_TARGET_WEIGHT).cuda()
    criterion = MultiLoss(cfg.LOSS.USE_TARGET_WEIGHT).cuda()
    #CenterLoss(cfg.LOSS.USE_TARGET_WEIGHT, cfg.LOSS.LAMDA).cuda()
